                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <div class="JobCategoryItem" onclick="SelectThisCategory($(this))" url="{{ route('GetAllJobsByCountry') }}?CountryID={{ $_GET['CountryID'] }}">
                            ...
                            @foreach($searchCategories as $key => $searchCategory)
                                <div class="col-lg-2 col-md-4 col-sm-6">
                                    <div class="JobCategoryItem" onclick="SelectThisCategory($(this))" url="{{ route('GetByCategoriesJobsByCountry', [$searchCategory->id]) }}?CountryID={{ $_GET['CountryID'] }}">
