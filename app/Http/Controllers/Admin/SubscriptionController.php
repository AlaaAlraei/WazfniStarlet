...
class SubscriptionController extends Controller
{
    ...
    public function create()
    {
        ...
        $subscriptionTypes = SubscriptionType::all()->pluck('title', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    public function edit(Subscription $subscription)
    {
        ...
        return view('admin.subscriptions.edit', compact('subscription', 'subscriptionTypes'));
    }
